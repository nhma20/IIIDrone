...
ICM_20948_Status_e ICM_20948::begin(uint8_t csPin, SPIClass spi, uint32_t SPIFreq)
{
  if (SPIFreq > 7000000)
...
ICM_20948_Status_e ICM_20948_write_SPI(uint8_t reg, uint8_t *data, uint32_t len, void *user)
{
  ...
  // }
  // SPIClass *_spi = ((ICM_20948 *)user)->_spi; // Cast user field to ICM_20948_SPI type and extract the SPI interface pointer
